...
\begin{document}
	...
	\end{gather*}
	with scaling factor $\zeta\ge 1$, decay factor $\gamma\in(0,1)$, and cap $\eta_c>0$.
	...
	\begin{corollary}\label{cor:fixed_nc}
		...
		=: \bar\Delta_H.
		\]
		Moreover, there exists a neighborhood radius $\varepsilon_{\mathrm{nbhd}}=\cO(\epsilon_{\mathrm{mix}}^2)$
	...
	a natural starting point. Establishing a convergence guarantee for
	\textsc{AdaDisGrem} that does not require a priori knowledge of~$L_2$
	is of theoretical interest. More broadly, establishing formal lower bounds to determine whether
