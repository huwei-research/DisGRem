...
\begin{document}
	...
	\begin{itemize}[leftmargin=1.5em]
		...
		Under convexity, Lipschitz Hessians, and the bounded-iterates
		assumption (Assumption~\ref{ass:bounded_iterates}),
		...
		The $\cO(\varepsilon^{-1})$ bound is conditional on
		Assumption~\ref{ass:bounded_iterates}: this trajectory boundedness is
		not proved from the problem data but is empirically verified on all
		tested instances (Section~\ref{sec:experiments}).
	...
	The averaging projector is defined by
	$\J:=\frac{1}{N}\one\one^\top$, and the complementary projector
	is $\Pmat:=I-\J$.
	We denote the mixing rate $\rho := \normtwo{W-\J}$.
	...
	Since the graph is connected (see Assumption~\ref{ass:problem}\,(ii)),
	$1$ is the unique largest eigenvalue of $W$, and therefore $\rho<1$.
	...
	\begin{assumption}\label{ass:problem}
		...
		\begin{enumerate}[label=(\roman*),leftmargin=2em,itemsep=4pt,topsep=4pt]
			...
			\normtwo{\nabla^2 f_i(x)-\nabla^2 f_i(y)}\le L_2\norm{x-y}.
			\]
		\item The graph $\mathcal G$ is connected and $W$ is symmetric,
		doubly stochastic, and has positive diagonal entries.
	...
	\begin{remark}[$\varepsilon$-independence of the algorithm]\label{rem:eps-independence}
		The algorithm is not restarted or retuned for a prescribed~$\varepsilon$;
		the logarithmic mixing schedule~\eqref{eq:log_schedule_main} is fixed
		independently of the target accuracy.  The index $K_0(\varepsilon)$ enters
		only in the complexity proof as the first index after which the scheduled
		consensus errors fall below accuracy-dependent thresholds.
	\end{remark}

	\begin{remark}[Dimension dependence of the constants]\label{rem:dim-constants}
		The constants $C_K$ and $K_0(\varepsilon)$ in
		Theorem~\ref{thm:main} depend on $d$, $N$, $L_1$, $L_2$, $D$,
		$M$, and the spectral gap $1-\rho$.  In particular, the
		Frobenius--spectral norm conversion in the dispersion bounds
		introduces a factor $\sqrt{d}$; hence the iteration bound, while
		independent of~$\varepsilon$ up to $\cO(\varepsilon^{-1})$, is not
		dimension-free.
	\end{remark}
	...
	\url{https://github.com/huwei0121/DisGRem}.
	...
	The work of W.~Hu, Y.-X.~Yuan, and L.~Zhang was supported in part by NSFC (Grant 12288201) and the Chinese Academy of Sciences.
	...
	\begin{thebibliography}{99}
		...
		\newblock \textit{Mathematical Programming}, 127:245--295, 2011.
		
		\bibitem[Chang and Lin(2011)]{chang2011libsvm}
		C.-C.~Chang and C.-J.~Lin.
		\newblock {LIBSVM}: a library for support vector machines.
		\newblock \textit{ACM Transactions on Intelligent Systems and Technology}, 2(3):27:1--27:27, 2011.
		...
		\newblock \textit{IEEE Transactions on Signal Processing}, 65(10):2613--2628, 2017.
		...
		\newblock \textit{IEEE Transactions on Automatic Control}, 59(5):1131--1146, 2014.
		
		\bibitem[Mishchenko(2023)]{mishchenko2023rn}
		K.~Mishchenko.
		\newblock Regularized {N}ewton method with global $O(1/k^2)$ convergence.
		\newblock \textit{SIAM Journal on Optimization}, 33(3):1440--1462, 2023.
		...
		\newblock \textit{IEEE Transactions on Signal Processing}, 65(1):146--161, 2017.
		...
		\newblock \textit{IEEE Transactions on Signal and Information Processing over Networks}, 7:346--358, 2021.
		...
		\newblock \textit{IEEE Transactions on Automatic Control}, 54(1):48--61, 2009.
		...
		\newblock \textit{SIAM Journal on Optimization}, 27(4):2597--2633, 2017.
		...
		\newblock \textit{Mathematical Programming}, 108:177--205, 2006.
		...
		\newblock \textit{SIAM Journal on Optimization}, 25(2):944--966, 2015.
		...
		\newblock \textit{IEEE Transactions on Signal Processing}, 70:5900--5915, 2022.
		...
		\newblock \textit{IEEE Transactions on Signal Processing}, 67(3):708--723, 2019.
		...
		\newblock \textit{Computational Optimization and Applications}, 91:683--715, 2025.
		...
		\newblock In \textit{Proceedings of the 38th International Conference on Machine Learning (ICML)}, volume 139 of PMLR, pp.~2398--2409, 2021.
		...
		\newblock \textit{Mathematical Programming}, 204:1--25, 2024.
		...
		\newblock \textit{Neural Networks}, 174:106212, 2024.
		...
		\newblock \textit{IEEE Transactions on Automatic Control}, 66(6):2787--2794, 2021.
		...
		\newblock \textit{SIAM Journal on Optimization}, 27(2):1171--1203, 2017.
		...
		\newblock In \textit{Advances in Neural Information Processing Systems (NeurIPS)}, 35:14013--14029, 2022.
		
		\bibitem[Doikov and Nesterov(2022)]{doikov2022tensor}
		N.~Doikov and Y.~Nesterov.
		\newblock Local convergence of tensor methods.
		\newblock \textit{Mathematical Programming}, 193:315--336, 2022.
		...
		\newblock In \textit{Proceedings of the International Conference on Machine Learning (ICML)}, pp.~3478--3487, 2019.
		...
		\newblock \textit{Journal of Machine Learning Research}, 25(274):1--52, 2024.
		...
		\newblock \textit{IEEE Transactions on Signal and Information Processing over Networks}, 2(4):507--522, 2016.
		
		\bibitem[Pu and Nedi{\'c}(2021)]{pu2021distributed}
		S.~Pu and A.~Nedi{\'c}.
		\newblock Distributed stochastic gradient tracking methods.
		\newblock \textit{Mathematical Programming}, 187:409--457, 2021.
		...
		\newblock \textit{IEEE Transactions on Automatic Control}, 65(6):2627--2633, 2020.
		...
		\newblock \textit{Journal of Machine Learning Research}, 21(180):1--51, 2020.
		
		\bibitem[Nesterov(2005)]{nesterov2005smooth}
		Y.~Nesterov.
		\newblock Smooth minimization of non-smooth functions.
		\newblock \textit{Mathematical Programming}, 103(1):127--152, 2005.
		...
		\newblock \textit{IEEE Transactions on Image Processing}, 6(2):298--311, 1997.
		...
		\newblock \textit{The Computer Journal}, 3(3):175--184, 1960.
		...
		\newblock \textit{Neural Networks}, 3(4):467--483, 1990.
		
		\bibitem[Geman and Yang(1995)]{geman1995nonlinear}
		D.~Geman and C.~Yang.
		\newblock Nonlinear image recovery with half-quadratic regularization.
		\newblock \textit{IEEE Transactions on Image Processing}, 4(7):932--946, 1995.
	...
	\begin{proof}[Proof of Lemma~\ref{lem:consensus}]
		...
		\begin{align*}
			(W\!-\!\J)^{t+1}&=(W\!-\!\J)^t(W\!-\!\J)\\
			&=(W^t\!-\!\J)(W\!-\!\J)\\
			&=W^{t+1}\!-\!W^t\J\!-\!\J W\!+\!\Jpar^2\\
			&=W^{t+1}\!-\!\J,
		\end{align*}
		using $W^t\J=\J$, $\J W=\J$, and $\Jpar^2=\J$.
